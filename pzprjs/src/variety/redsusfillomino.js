//
// パズル固有スクリプト部 フィルオミノ版 redsusfillomino.js
//
...
MouseEvent:{
	...
	dragnumber_redsusfillomino : function(){
...
KeyEvent:{
	...
	moveTarget : function(ca){
		if(this.puzzle.playmode && (this.isCTRL || this.isX || this.isZ)){
			return this.move_redsusfillomino(ca);
		}
		return this.moveTCell(ca);
	},

	move_redsusfillomino : function(ca){
...
AnsCheck:{
	checklist : [
		...
		"checkNumKinds",
		"checkNoNumArea",
		"checkNoNumCell_redsusfillomino+"
	],
	...
	checkNoNumCell_redsusfillomino : function(){
