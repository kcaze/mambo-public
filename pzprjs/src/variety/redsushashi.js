//
// パズル固有スクリプト部 橋をかけろ版 redsushashi.js
//
...
Graphic:{
	...
	// オーバーライド
	drawLines_redsushashi : function(id){
...
FileIO:{
	...
	kanpenOpenXML : function(){
		...
		this.decodeBorderLine_redsushashi_XMLAnswer();
	},
	kanpenSaveXML : function(){
		this.encodeCellQnum_XMLBoard();
		this.encodeBorderLine_redsushashi_XMLAnswer();
	},

	UNDECIDED_NUM_XML : 9,

	decodeBorderLine_redsushashi_XMLAnswer : function(){
		this.decodeCellXMLArow(function(cell, name){
			cell.setState(+name.substr(1));
		});
	},
	encodeBorderLine_redsushashi_XMLAnswer : function(){
